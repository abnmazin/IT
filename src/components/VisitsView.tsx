  ...
  const renderVisit = (visit: Visit) => {
    ...
    return (
      ...
      >
        ...
        <div className="flex items-center gap-1 text-[10px] sm:text-[11px] text-slate-500 mb-2">
        ...
        <div className="mt-2 flex gap-1.5">
          ...
          {visit.status === "inactive" && (
            <button
              onClick={(e) => { e.stopPropagation(); onToggleVisit(visit.id); }}
              className="flex-1 flex items-center justify-center gap-1 px-2 py-1.5 bg-emerald-600 text-white rounded-lg text-[11px] font-medium hover:bg-emerald-700 transition-colors"
            >
